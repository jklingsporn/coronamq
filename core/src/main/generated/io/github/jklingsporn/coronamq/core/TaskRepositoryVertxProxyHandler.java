      ...
      switch (action) {
        ...
        case "updateTask": {
          service.updateTask((java.lang.String)json.getValue("id"),
                        json.getString("newStatus") == null ? null : TaskStatus.valueOf(json.getString("newStatus")),
                        json.getString("oldStatus") == null ? null : TaskStatus.valueOf(json.getString("oldStatus"))).onComplete(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "requestTask": {
