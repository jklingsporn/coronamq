 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link de.badmonkee.coronamq.core.Broker original} non RX-ified interface using Vert.x codegen.
 */

@RxGen(de.badmonkee.coronamq.core.Broker.class)
public class Broker {
  ...
  public static final TypeArg<Broker> __TYPE_ARG = new TypeArg<>(    obj -> new Broker((de.badmonkee.coronamq.core.Broker) obj),
    Broker::getDelegate
  );
