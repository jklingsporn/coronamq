 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link de.badmonkee.coronamq.core.Worker original} non RX-ified interface using Vert.x codegen.
 */

@RxGen(de.badmonkee.coronamq.core.Worker.class)
public class Worker {
  ...
  public static final TypeArg<Worker> __TYPE_ARG = new TypeArg<>(    obj -> new Worker((de.badmonkee.coronamq.core.Worker) obj),
    Worker::getDelegate
  );
