 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link de.badmonkee.coronamq.core.bootstrap.Bootstrap original} non RX-ified interface using Vert.x codegen.
 */

@RxGen(de.badmonkee.coronamq.core.bootstrap.Bootstrap.class)
public class Bootstrap {
  ...
  public static final TypeArg<Bootstrap> __TYPE_ARG = new TypeArg<>(    obj -> new Bootstrap((de.badmonkee.coronamq.core.bootstrap.Bootstrap) obj),
   ...
   */
  public de.badmonkee.coronamq.core.rxjava3.bootstrap.Bootstrap withRepository() { 
   ...
   * @return a reference to this
   */
  public de.badmonkee.coronamq.core.rxjava3.bootstrap.Bootstrap withRepository(de.badmonkee.coronamq.core.rxjava3.TaskRepository repository) { 
   ...
   * @return a reference to this
   */
  public de.badmonkee.coronamq.core.rxjava3.bootstrap.Bootstrap withBroker() { 
    delegate.withBroker();
    return this;
  }
   ...
   * @return a reference to this
   */
  public de.badmonkee.coronamq.core.rxjava3.bootstrap.Bootstrap withBroker(de.badmonkee.coronamq.core.rxjava3.Broker broker) { 
   ...
   * @return 
   */
  public de.badmonkee.coronamq.core.rxjava3.bootstrap.Bootstrap withWorker(de.badmonkee.coronamq.core.rxjava3.Worker worker) { 
   ...
   * @return 
   */
  public io.reactivex.rxjava3.core.Single<de.badmonkee.coronamq.core.rxjava3.bootstrap.BootstrapSpreadStep> spread() { 
    io.reactivex.rxjava3.core.Single<de.badmonkee.coronamq.core.rxjava3.bootstrap.BootstrapSpreadStep> ret = rxSpread();
    ret = ret.cache();
   ...
   * @return 
   */
  public io.reactivex.rxjava3.core.Single<de.badmonkee.coronamq.core.rxjava3.bootstrap.BootstrapSpreadStep> rxSpread() { 
    return AsyncResultSingle.toSingle(delegate.spread(), __value -> de.badmonkee.coronamq.core.rxjava3.bootstrap.BootstrapSpreadStep.newInstance((de.badmonkee.coronamq.core.bootstrap.BootstrapSpreadStep)__value));
  }
